...
import { Alert, AutoComplete, Button, Checkbox, Col, Input, Modal, Row, Space } from 'antd';
...
function PropertySellDetails() {
  ...
  return (
    <PageContainer
      header={{
        breadcrumb: {
          ...
          routes: [
            ...
            {
              path: 'property-sell',
              breadcrumbName: 'Danh sách BĐS bán',
            },
            {
      ...
      title={
        <>
          <a href="/property-sell" className="ant-page-header-heading-back" title="back">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
    ...
    >
      <ProCard title="Thông tin BĐS bán" direction="column" headerBordered>
        ...
        >
          <Row gutter={{ xs: 12, sm: 12, md: 24 }}>
            ...
            <Col span={12} lg={{ span: 12 }} xl={{ span: 6 }}>
              <div className="proform-item-button form-checkbox-end">
                <Checkbox>Nội bộ bán</Checkbox>
              </div>
            </Col>
            <Col span={12} lg={{ span: 12 }} xl={{ span: 6 }}>
              <div className="proform-item-button">
                <Button type="primary" size="small" ghost shape="circle">
                  Cập nhật thông tin
                </Button>
              </div>
            </Col>
          ...
          <h3 className="section-title">Lịch sử thay đổi tình trạng BĐS</h3>
          <ProTable<DataSource>
            columns={columns}
            search={false}
            toolBarRender={false}
      ...
      <ModalForm
        width={480}
        title="Ghi chú thay đổi tình trạng BĐS"
        visible={isVisible}
        submitter={{
          searchConfig: {
            submitText: 'Mở BĐS',
      ...
      >
        <ProFormTextArea
          label="Các giá trị thay đổi bao gồm"
          placeholder={'Nhập các giá trị thay đổi'}
        />
      </ModalForm>
    </PageContainer>
  );
...
export default PropertySellDetails;
