...
export default function Preview() {
  ...
  const onFinish = async (data: any) => {
    ...
    const insertCloneRealEstate = async () => {
      ...
      const { data: real_estate_id, keyResponse } = await realEstateRentService
      ...
      if (typeof real_estate_id === 'string') {
        message.success(
          ...
          async () => {
            ...
            history.push(`/real-estate-rent/${real_estate_id}`);
          },
        );
      } else if (keyResponse) {
  ...
  return (
    <PageContainer
      header={{
        title: intl.formatMessage({ id: 'pages.real_estate_rent.preview' }),
        ghost: true,
        breadcrumb: {
          ...
          routes: [
            ...
            {
              path: '',
              breadcrumbName: intl.formatMessage({ id: 'pages.real_estate_rent.preview' }),
            },
          ],
        },
        extra: [],
